...
export class TableView implements NodeView {
  ...
  constructor(public node: Node, public defaultCellMinWidth: number, public defaultCellMinHeight: number) {
    ...
    updateRowsOnResize(node, this.tbody, this.table, defaultCellMinHeight);
  ...
  update(node: Node): boolean {
    ...
    updateRowsOnResize(node, this.tbody, this.table, this.defaultCellMinHeight);
    return true;
  }
